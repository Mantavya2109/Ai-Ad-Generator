...
export default function Hero() {
  ...
  const mainImageUrl = "https://wallpapercave.com/wp/wp4457527.jpg";
  ...
  const trustedLogosText = ["Nike", "H & M", "Naplet", "Avengers", "Realme"];
            ...
            <div className="text-left">
              ...
              >
                ...
                <span className="text-xs text-gray-200/90">
                  Used by thousands of people locally
                </span>
              </motion.a>
              ...
              >
                A AI driven web app that is made for startups to make short
                videos/shorts/reels for promotion,branding and advertisments.
              </motion.p>
              ...
              >
                ...
                <div className="flex items-center gap-2 p-2 px-3 sm:px-6.5 hover:bg-white/3 transition-colors">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-400">Use anywhere</div>
                  </div>
                </div>
              </motion.div>
            </div>
