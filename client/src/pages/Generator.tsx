...
const Generator = () => {
  ...
  const handleGenerate = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!productImage || !modelImage || !name || !productName || !aspectratio) {
      return toast("Please fill all the required details");
    }
    ...
    <div className="min-h-screen text-white p-6 md:p-12 mt-28">
      <form onSubmit={handleGenerate} className="max-w-4xl mx-auto mb-40">
        <Title
          ...
          description="Upload your model and product image to generate AI UGC, shorts, reels and social media posts"
        />
        <div className="flex gap-20 max-sm:flex-col items-start justify-between">
          ...
          <div className="w-full">
            ...
            <div className="mb-4 text-gra y-300">
            ...
            <div className="mb-4 text-gray-300">
              ...
              <textarea
                ...
                placeholder="Tell your narration"
                className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/50 outline-none transition-all"
              />
            </div>
          </div>
        ...
        <div className="flex justify-center mt-10">
          ...
          >
            {isGenerating ? (
              <>
                <Loader2Icon className="size-5 animate-spin" /> Genarating...
              </>
            ) : (
              <>
                <Wand2Icon className="size-5" /> Generate AI Ad
              </>
            )}
          </PrimaryButton>
        </div>
